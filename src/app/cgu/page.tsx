...
export default function CGUPage() {
  ...
  return (
    <LegalPage title="Conditions Générales d’Utilisation" updatedAt="17/02/2026">
      ...
      <section className="space-y-5">
        <h2 className="text-xl font-bold text-slate-900">Offres partenaires, absence de garantie</h2>
        <ul className="list-disc pl-5 text-sm leading-6 text-slate-700 space-y-2">
          <li>
      ...
      <section className="space-y-5">
        <h2 className="text-xl font-bold text-slate-900">Affiliation</h2>
        <p className="text-sm leading-6 text-slate-700">
      ...
      <section className="space-y-5">
        <h2 className="text-xl font-bold text-slate-900">Disponibilité et maintenance</h2>
        <p className="text-sm leading-6 text-slate-700">
      ...
      <section className="space-y-5">
        <h2 className="text-xl font-bold text-slate-900">Responsabilité (limitation)</h2>
        <p className="text-sm leading-6 text-slate-700">
      ...
      <section className="space-y-5">
        <h2 className="text-xl font-bold text-slate-900">Droit applicable et règlement amiable des litiges</h2>
        <p className="text-sm leading-6 text-slate-700">
